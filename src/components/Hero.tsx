    ...
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        <div className="animate-fade-in">
          {/* Logo */}
          <div className="mb-8">
            <h1 className="font-playfair text-6xl md:text-8xl font-bold text-white mb-2">
              Blush Beauty
            </h1>
          ...
          {/* Tagline */}
          <p className="font-inter text-xl md:text-2xl text-pink-100 mb-8 max-w-2xl leading-relaxed">
